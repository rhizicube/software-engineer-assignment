...
LANGUAGES:  Python, Javascript, SQL, Golang, Java, Scala, Ruby
...
1. Please DO NOT submit the code using any git repo
2. Please zip your code and share it over email.